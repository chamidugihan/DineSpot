 ...
 * @author lenovo
 */
public class inventoryStatus extends javax.swing.JDialog {
    ...
    public inventoryStatus(java.awt.Frame parent, boolean modal , String id) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            MySQL.execute("UPDATE `inventory` SET `status_id`='"+status_id+"' WHERE `id`='"+id+"'");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                inventoryStatus dialog = new inventoryStatus(new javax.swing.JFrame(), true, id);
